...
export const characters: CharacterObject[] = [
  {
    ...
    images: 10,
    music: 'https://open.spotify.com/embed/track/6t74To2T8PUd6k1dbSu10D?utm_source=generator',
...

  {
    ...
    music: 'https://open.spotify.com/embed/track/1QUX7xOPs80O5tiQb3MPqd?utm_source=generator',
...

  {
    ...
    music: 'https://open.spotify.com/embed/track/5FQuOO8w56VPX1tJwaPKx8?utm_source=generator',
    alternateNames: ['Sholmes', 'Holmes'],
    tags: ['homumiko', 'ryuulock', 'doyle', 'herlock'],
    lastUpdated: null,
...

  {
    ...
    music: 'https://open.spotify.com/embed/track/0EFqdvTgJMPd02XUUCsHnI?utm_source=generator',
    tags: ['homumiko', 'ryuulock', 'doyle', 'herlock'],
    lastUpdated: '2023-04-17',
...

  {
    ...
    images: 16,
    music: 'https://open.spotify.com/embed/track/09pXZRySXfq6Z17YiVnOJC?utm_source=generator',
    tags: [],
...

  {
    ...
    images: 6,
    music: 'https://open.spotify.com/embed/track/5OmhUtWkaW7czq8v42yjIg?utm_source=generator',
...

  {
    ...
    appearsIn: [false, false, true, true, true, false, true, true, true, true],
    images: 9,
    music: 'https://open.spotify.com/embed/track/3oCMdfOMvnlS9BBAZ2YBQ5?utm_source=generator',
    tags: ['doyle', 'watson'],
    lastUpdated: null,
    posesAddedOnLastUpdate: 0,
  },

  {
    ...
    appearsIn: [false, false, true, true, true, false, true, true, true, true],
    images: 5,
    music: 'https://open.spotify.com/embed/track/657DqxHnOmnX3ZRJlbs9xZ?utm_source=generator',
    tags: ['doyle'],
    lastUpdated: null,
    posesAddedOnLastUpdate: 0,
  },

  {
    ...
    images: 9,
    music: 'https://open.spotify.com/embed/track/582mS91YcS5PHaTx5LUPn4?utm_source=generator',
...

  {
    ...
    music: 'https://open.spotify.com/embed/track/7rePNo1I17JmU49JX6rbnE?utm_source=generator',
...

  {
    ...
    images: 4,
    music: 'https://open.spotify.com/embed/track/4qiFdo2jEF4AcZzj8LxPUP?utm_source=generator',
    tags: ['asobaro', 'baroasoryuu'],
...

  {
    ...
    images: 9,
    music: 'https://open.spotify.com/embed/track/0hWRHYklo8CRyV8BxVQugG?utm_source=generator',
    tags: ['natsume'],
    lastUpdated: null,
    posesAddedOnLastUpdate: 0,
  },

  {
    ...
    images: 4,
    music: 'https://open.spotify.com/embed/track/1QBM9EnE2HiyIvEL1vz8U6?utm_source=generator',
    tags: ['doyle'],
    lastUpdated: null,
    posesAddedOnLastUpdate: 0,
  },
...

  {
    ...
    appearsIn: [false, false, false, false, false, false, false, true, false, false],
    images: 1,
    music: 'https://open.spotify.com/embed/track/3c4rqLvhHImiVKNPD0IN1V?utm_source=generator',
    tags: [],
    lastUpdated: null,
    posesAddedOnLastUpdate: 0,
...

  {
    ...
    appearsIn: [false, false, false, false, false, false, false, true, false, false],
    images: 2,
    music: 'https://open.spotify.com/embed/track/3R1YvtpoUWBWy6OGd92nU0?utm_source=generator',
    tags: [],
    lastUpdated: null,
    posesAddedOnLastUpdate: 0,
  },
...

  {
    ...
    images: 1,
    music: 'https://open.spotify.com/embed/track/6x6OrJ2G3rdwTyYVFuezBf?utm_source=generator',
    tags: [],
...

  {
    ...
    appearsIn: [false, false, true, true, true, false, true, true, true, true],
    images: 1,
    music: 'https://open.spotify.com/embed/track/4g9GzmDyca2VZg7j5kx6AT?utm_source=generator',
    tags: [],
...

  {
    ...
    gender: 'male',
    nationality: 'british',
    music: 'https://open.spotify.com/embed/track/6chpyq6Skg5UDY3oj2CsB9?utm_source=generator',
    appearsIn: [false, false, false, false, true, false, false, false, false, false],
    images: 9,
    tags: ['doyle'],
    alternateNames: ['Windibank', 'Hatch'],
