...
const poseSelector = document.querySelector("#pose-selector-preview");
...
function generateLocations() {
    locations_js_1.locations.forEach(function (location) {
...
function getCharacterFromID(characterID) {
    return characters_js_1.characters.find((character) => character.id === characterID);
}
...
function propagateAlternateNames() {
    ...
    tagImages.forEach((image) => {
        ...
        if (thisCharacter) {
            let currentCharacter = (_a = characters_js_1.characters.find((character) => { var _a; return ((_a = character.alternateNames) !== null && _a !== void 0 ? _a : []).includes(String(image.getAttribute('character'))); })) !== null && _a !== void 0 ? _a : getCharacterFromID(thisCharacter);
...
function generateCharacterInterface() {
    ...
    characters_js_1.characters.forEach(function (character) {
    ...
    locations_js_1.locations.forEach(function (location) {
        ...
        icon.addEventListener("click", function (e) {
            ...
            if (value) {
                ...
                characterOverlayID = (_b = (_a = locations_js_1.locations.find((location) => location.id === backgroundSelector.value)) === null || _a === void 0 ? void 0 : _a.characterOverlay) !== null && _b !== void 0 ? _b : null;
            }
  ...
  `;
    ...
    function updateNamesLanguage(e) {
        ...
        Object.keys(alternateNamesInUse).forEach((altName) => {
            ...
            let character = characters_js_1.characters.find((character) => { var _a; return ((_a = character.alternateNames) !== null && _a !== void 0 ? _a : []).includes(altName); });
    ...
    for (const [key] of Object.entries(alternateNamesInUse)) {
        let myCharacter = characters_js_1.characters.find((character) => { var _a; return ((_a = character.alternateNames) !== null && _a !== void 0 ? _a : []).includes(key); });
...
function initialiseCumberbatchTheme() {
    ...
    characters_js_1.characters.unshift({
