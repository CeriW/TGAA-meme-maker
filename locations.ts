...
export const locations: LocationObject[] = [
  {name   : "Sholmes' Suite",                        id:"sholmes-suite",                                   variant: "Fireplace",                        tags: ['homumiko', 'ryuulock', 'doyle'], addedDate: null},
  {name   : "Sholmes' Suite",                        id:"sholmes-suite-sholmes",                           variant:"Herlock's side",            tags: ['homumiko','ryuulock', 'doyle'], addedDate: null},
  {name   : "Sholmes' Suite",                        id:"sholmes-suite-iris",                              variant:"Iris' side",        tags: ['homumiko','ryuulock', 'doyle'], addedDate: null},
  {name   : "Naruhodo's Legal Consultancy",          id:"naruhodos-legal-consultancy",                     tags: ['ryuulock',  'baroasoryuu'], addedDate: null},
  {name   : "221B Baker Street",                     id:"baker-street-221b",                               tags: ['homumiko', 'doyle'], addedDate: null},
  {name   : "221B Baker Street",                     id:"baker-street-221b-night",                         variant:"Night",                             tags: ['homumiko', 'doyle'], addedDate: null},
  {name   : "Defendant's Antechamber",               id:"defendants-antechamber-the-old-bailey-left",      variant:'The Old Bailey', tags: ['asobaro', 'baroasoryuu'], addedDate: null},
  {name   : "Defendant's Antechamber",               id:"defendants-antechamber-japan-right",              variant:'Japanese Court of Judicature', tags: ['asobaro','baroasoryuu'], addedDate: null},
  ...
  {name   : "Forensics Laboratory",                  id:"forensics-laboratory-courtney",                   variant: "Courtney's version", tags: [], addedDate: null},
  {name   : "Forensics Laboratory",                  id:"forensics-laboratory-maria",                      variant:"Maria's version", tags: [], addedDate: null},
  ...
  {name   : "First Class Cabin no.1 ",               id:"ss-burya-cabin-1",                                variant: "Kazuma's room", tags: ['asobaro', 'baroasoryuu'], addedDate: null},
