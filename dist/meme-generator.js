...
const customBackgroundInput = document.querySelector('#custom-background-input');
...
randomAnimalHome === null || randomAnimalHome === void 0 ? void 0 : randomAnimalHome.appendChild(randomAnimal);
// ---------------------------------------------------------------------------//
...
function propagateAlternateNames() {
    ...
    tagImages.forEach((image) => {
        ...
        if (thisCharacter) {
            ...
            let tagPath = alternateNamesInUse[thisCharacter]
...
function generateCanvas() {
    ...
    const placeholderText = document.querySelectorAll('.canvas-container').length % 2
    ...
    newTextBox.addEventListener('input', (e) => {
        ...
        if (preview) {
            ...
            const editedWords = thisTextBox.value.replace(regex, (match, p1) => {
                ...
                return (' <span style="color: var(--orange);">' +
...
function determineStickyCanvas() {
    ...
    if (window.innerWidth > 1450 &&
        ((_a = document.querySelector('#canvas-grid-item > div')) === null || _a === void 0 ? void 0 : _a.offsetHeight) <
            window.innerHeight - ((_b = document.querySelector('#info-bar')) === null || _b === void 0 ? void 0 : _b.clientHeight) + 100) {
    ...
    locations.forEach(function (location) {
        ...
        icon.addEventListener('click', function (e) {
            ...
            if (value) {
                ...
                characterOverlayID =
                    (_b = (_a = locations.find((location) => location.id === backgroundSelector.value)) === null || _a === void 0 ? void 0 : _a.characterOverlay) !== null && _b !== void 0 ? _b : null;
            }
...
function generateCharacterDescriptionCard(character) {
  ...
  `
    ...
    <div class="character-description-card">
      ...
      ${spotify !== null && spotify !== void 0 ? spotify : ''}
    </div>
    `;
}
