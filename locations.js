...
let locations = [
  ...
  {name   : "Naruhodo's Legal Consultancy",          id:"naruhodos-legal-consultancy",                     tags: ['ryuulock']},
  {name   : "Defendant's Antechamber",               id:"defendants-antechamber-the-old-bailey-left",      variant:'The Old Bailey', tags: ['asobaro']},
  {name   : "Defendant's Antechamber",               id:"defendants-antechamber-japan-right",              variant:'Japanese Court of Judicature', tags: ['asobaro']},
  {name   : "Prosecutor's Office",                   id:"prosecutors-office-left",                         tags: ['asobaro']},
  ...
  {name   : "First Class Cabin no.1 ",               id:"ss-burya-cabin-1",                                variant: "Kazuma's room", tags: ['asobaro']},
